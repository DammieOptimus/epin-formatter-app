document.addEventListener('DOMContentLoaded', () => {
    ...
    // Added reference for the developer name display
    ...
    const updateStaticNames = () => {
        ...
        // Update the developer name display div
        if (developerNameDisplay) { // Check if element exists
             developerNameDisplay.textContent = DEVELOPER_NAME;
        }
    };
    ...
    const formatPin = (pin) => { /* ... same as before ... */
    ...
    const getLoadCode = (network, originalPin) => { /* ... same as before ... */
    ...
    const formatDate = (date) => { /* ... same as before ... */
    ...
    const getExpiryInfo = (network) => { /* ... same as before ... */
    ...
    const parseRawEpins = (rawText) => { /* ... same parsing logic as previous update ... */
        const epins = [];
        ...
        if (networkAmountMatches.length === 0) return epins;
    ...
    const updateAnalytics = (epins) => { /* ... same as before ... */
        parsedEpins = epins;
    ...
    const generatePrintPage = (epinsToPrint, userBusinessName) => {
        ...
        // Convert user business name to uppercase for printing
        ...
        epinsToPrint.forEach(epin => {
            ...
            // Use the uppercase business name here
    ...
    // --- Initialisation ---
    updateStaticNames(); // Set initial names and copyright
